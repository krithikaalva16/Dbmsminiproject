            ...
            <div class="d-flex flex-sm-column flex-row flex-grow-1 align-items-center align-items-sm-start px-3 pt-2 text-white">
                ...
                <div class="dropdown py-sm-4 mt-sm-auto ms-auto ms-sm-0 flex-shrink-1">
                    <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <span class="d-none d-sm-inline mx-1"><?php echo $_SESSION["f_id"];?></span>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-dark text-small shadow" aria-labelledby="dropdownUser1">
                        ...
                        <li><a class="dropdown-item" href="faculty_update.php?f_id=<?php echo $_SESSION['f_id']; ?>">Profile</a></li>
                        <li>
                ...
                <div class="col pt-4">
                  ...
                  <div class="row">
                    <?php
                        ...
                        $record="SELECT * FROM faculty_course WHERE id='$f_id'";
                    ...
                    <div class="col-xl-3 col-sm-6 mb-3">
                      <div class="card text-white bg-warning o-hidden h-100">
                        ...
                        <a class="card-footer text-white clearfix small z-1 text-decoration-none" 
                        href="manage_result.php?course=<?php echo $row['course'];?>">
